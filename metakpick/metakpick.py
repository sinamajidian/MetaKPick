...
def main():
    ...
    if mode=="train":
        ...
        output_file_name= _utils.write_estimated_tax(estimated_tax_dict,output_file_name=workingdir+"../results/estimated_tax.csv")
        logging.info("Done")
    ...
    if mode=="test":
        ...
        estimated_tax_dict = _utils.read_estimated_tax(output_file_name=workingdir+"../results/estimated_tax.csv")
