...
def main():
    ...
    if mode=="train":
        ...
        features_cases, feature_names = _training.get_features_all(read_names_list, tax2path, kraken_kmers_cases, cases, read_tax_depth, tax2depth, info, parents, classification_folder)
        ...
        regr_dic,read_k_prob = _training.train_RF_model_all(cases, features_cases, tp_binary_reads_cases,read_names_list,n_estimators=1000, max_features=float(0.8), max_leaf_nodes=50, random_state=14, n_jobs=20) 
        ...
        best_k_dic,estimated_tax_dict =_training.get_best_tax(read_k_prob,cases,read_names_list,merged_limited,thr_minprob=0.5)
